## Figure A1 in manuscript. This script runs the traceplots for the Great Lakes
...
## Run the model
GLMultiSiteNo2year <- jags(jags.data, inits, trace.parameters, "GLMultiSiteNo2year.jags",
...
setwd("/Users/emilyfiliberti/Desktop/OneDrive - University of Maine System/Manuscripts/Historical GWWA Survival/Tables and Figures/Figure A1/")


# Generate traceplots and save them as ggplot objects
traceplot <- MCMCtrace(object = GLMultiSiteNo2year$samples,
                       ISB = FALSE,
                       exact = TRUE,
                       pdf = TRUE)
