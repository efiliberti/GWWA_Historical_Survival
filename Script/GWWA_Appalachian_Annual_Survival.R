...
## model for the Appalachian Mountain population of Golden-winged Warbler. Eight 
## CMR historical datasets ranging from 2001-2021 were collected and compiled. 
...
parameters <- c('overall.female.survival', 'overall.male.survival',
                'overall.f.AWV.phi', 'overall.m.AWV.phi', 'phi.AWV', 'p.AWV', 'delta.phi.AWV',
                'overall.f.CNY.phi', 'overall.m.CNY.phi', 'phi.CNY', 'p.CNY', 'delta.phi.CNY',
                'overall.f.KNC.phi', 'overall.m.KNC.phi', 'phi.KNC', 'p.KNC', 'delta.phi.KNC',
                'overall.f.PAE.phi', 'overall.m.PAE.phi', 'phi.PAE', 'p.PAE', 'delta.phi.PAE',
                'overall.f.PAC.phi', 'overall.m.PAC.phi', 'phi.PAC', 'p.PAC', 'delta.phi.PAC',
                'overall.f.SNC.phi', 'overall.m.SNC.phi', 'phi.SNC', 'p.SNC', 'delta.phi.SNC',
                'overall.f.CWV.phi', 'overall.m.CWV.phi', 'phi.CWV', 'p.CWV', 'delta.phi.CWV',
                'overall.f.BTN.phi', 'overall.m.BTN.phi', 'phi.BTN', 'p.BTN', 'delta.phi.BTN',
                ...
                'overall.delta.phi.AWV', 'overall.delta.phi.CNY','overall.delta.phi.KNC','overall.delta.phi.PAC',
                'overall.delta.phi.SNC','overall.delta.phi.CWV','overall.delta.phi.BTN',
...
## Run the model
AppsMultiSiteNo2year <- jags(jags.data, inits, parameters, "AppMultiSiteNo2year.jags",
